...
ServerEvents.recipes(allthemods => {
    ...
    cell('kubejs:white_dye_cell', 'allthecompressed:white_concrete_6x', 'minecraft:lava_bucket', 'minecraft:water_bucket', 'megacells:cell_component_256m')
    cell('kubejs:light_gray_dye_cell', 'allthecompressed:light_gray_concrete_6x', 'minecraft:lava_bucket', 'minecraft:water_bucket', 'megacells:cell_component_256m')
    cell('kubejs:gray_dye_cell', 'allthecompressed:gray_concrete_6x', 'minecraft:lava_bucket', 'minecraft:water_bucket', 'megacells:cell_component_256m')
    cell('kubejs:black_dye_cell', 'allthecompressed:black_concrete_6x', 'minecraft:lava_bucket', 'minecraft:water_bucket', 'megacells:cell_component_256m')
    cell('kubejs:brown_dye_cell', 'allthecompressed:brown_concrete_6x', 'minecraft:lava_bucket', 'minecraft:water_bucket', 'megacells:cell_component_256m')
    cell('kubejs:red_dye_cell', 'allthecompressed:red_concrete_6x', 'minecraft:lava_bucket', 'minecraft:water_bucket', 'megacells:cell_component_256m')
    cell('kubejs:orange_dye_cell', 'allthecompressed:orange_concrete_6x', 'minecraft:lava_bucket', 'minecraft:water_bucket', 'megacells:cell_component_256m')
    cell('kubejs:yellow_dye_cell', 'allthecompressed:yellow_concrete_6x', 'minecraft:lava_bucket', 'minecraft:water_bucket', 'megacells:cell_component_256m')
    cell('kubejs:green_dye_cell', 'allthecompressed:green_concrete_6x', 'minecraft:lava_bucket', 'minecraft:water_bucket', 'megacells:cell_component_256m')
    cell('kubejs:lime_dye_cell', 'allthecompressed:lime_concrete_6x', 'minecraft:lava_bucket', 'minecraft:water_bucket', 'megacells:cell_component_256m')
    cell('kubejs:cyan_dye_cell', 'allthecompressed:cyan_concrete_6x', 'minecraft:lava_bucket', 'minecraft:water_bucket', 'megacells:cell_component_256m')
    cell('kubejs:light_blue_dye_cell', 'allthecompressed:light_blue_concrete_6x', 'minecraft:lava_bucket', 'minecraft:water_bucket', 'megacells:cell_component_256m')
    cell('kubejs:blue_dye_cell', 'allthecompressed:blue_concrete_6x', 'minecraft:lava_bucket', 'minecraft:water_bucket', 'megacells:cell_component_256m')
    cell('kubejs:purple_dye_cell', 'allthecompressed:purple_concrete_6x', 'minecraft:lava_bucket', 'minecraft:water_bucket', 'megacells:cell_component_256m')
    cell('kubejs:magenta_dye_cell', 'allthecompressed:magenta_concrete_6x', 'minecraft:lava_bucket', 'minecraft:water_bucket', 'megacells:cell_component_256m')
    cell('kubejs:pink_dye_cell', 'allthecompressed:pink_concrete_6x', 'minecraft:lava_bucket', 'minecraft:water_bucket', 'megacells:cell_component_256m')
})
