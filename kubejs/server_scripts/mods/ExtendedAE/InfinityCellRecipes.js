...
ServerEvents.recipes(allthemods => {
    ...
    cell('kubejs:dirt_cell', 'allthecompressed:dirt_7x', 'minecraft:water_bucket', 'minecraft:mud', 'megacells:cell_component_256m')
    cell('kubejs:moss_cell', 'allthecompressed:moss_block_6x', 'minecraft:bone_block', 'minecraft:bone_block', 'megacells:cell_component_256m')
    cell('kubejs:andesite_cell', 'allthecompressed:andesite_6x', 'minecraft:water_bucket', 'minecraft:lava_bucket', 'megacells:cell_component_256m')
    cell('kubejs:diorite_cell', 'allthecompressed:diorite_6x', 'minecraft:water_bucket', 'minecraft:lava_bucket', 'megacells:cell_component_256m')
    cell('kubejs:granite_cell', 'allthecompressed:granite_6x', 'minecraft:water_bucket', 'minecraft:lava_bucket', 'megacells:cell_component_256m')
    ...
    cell('kubejs:end_stone_cell', 'allthecompressed:end_stone_7x', 'minecraft:purpur_block', 'minecraft:purpur_block', 'megacells:cell_component_256m')
    cell('kubejs:netherrack_cell', 'allthecompressed:netherrack_7x', 'minecraft:lava_bucket', 'minecraft:gravel', 'megacells:cell_component_256m')
    ...
    cell('kubejs:cobbled_deepslate_cell', 'allthecompressed:cobbled_deepslate_7x', 'minecraft:lava_bucket', 'minecraft:packed_ice', 'megacells:cell_component_256m')
